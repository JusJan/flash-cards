...
(function() {
    var provider = app.data.flashCardsBackend = new Everlive({
            offlineStorage: true,
            apiKey: 'mihd8Xpk66olhsem',
    ...
    document.addEventListener('online', function() {
        app.data.flashCardsBackend.offline(false);
        app.data.flashCardsBackend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.flashCardsBackend.offline(true);
    });

}());

// START_CUSTOM_CODE_flashCardsBackend
// END_CUSTOM_CODE_flashCardsBackend